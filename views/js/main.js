...
var resizePizzas = function(size) {
    ...
    //Get pizza count and new width outside of for loop
...
//Moved pizzaDiv variable declaration outside for loop
...
function updatePositions() {
    ...
    //Set document.body.scrollTop to a variable outside of for loop
    var dbScrollTop = document.body.scrollTop;
    for (var i = 0; i < items.length; i++) {
        var phase = Math.sin((dbScrollTop / 1250) + (i % 5));
